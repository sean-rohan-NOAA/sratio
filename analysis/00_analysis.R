...
# Input: None
# Output: 
#     (1-1) ./data/hauls_1530.rds
#     (1-2) ./data/catch_1530.rds
#     (1-3) ./data/fish_lengths_1530.rds
#     (1-4) ./data/crab_size_1530.rds
#     (1-5) ./data/fish_crab_size_1530.rds

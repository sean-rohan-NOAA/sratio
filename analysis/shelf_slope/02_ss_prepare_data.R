...
saveRDS(object = dat_binned, 
        file = here::here("analysis", "shelf_slope", "output", "catch_at_length_ss.rds"))

saveRDS(object = dat_sratio, 
        file = here::here("analysis", "shelf_slope", "output", "n_by_treatment_ss.rds"))

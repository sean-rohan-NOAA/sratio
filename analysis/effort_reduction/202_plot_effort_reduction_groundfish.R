...
for(kk in 1:length(loop_area_id)) {
  ...
  png(filename = 
        here::here("analysis", "effort_reduction", "plots", sub_dir, survey_set, 
                   paste0(survey_set, "_fish_", sub_dir, "_", loop_area_id[kk], "_biomass_ts.png")),
      width = 8, 
      height = 6, 
      units = "in", 
      res = 300)
  ...
  png(filename = 
        here::here("analysis", "effort_reduction", "plots", sub_dir, survey_set, 
                   paste0(survey_set, "_fish_", sub_dir, "_", loop_area_id[kk], "_cv_ts.png")),
      width = 8, 
      height = 6, 
      units = "in", 
      res = 300)
  ...
  png(filename = 
        here::here("analysis", "effort_reduction", "plots", sub_dir, survey_set, 
                   paste0(survey_set, "_fish_", sub_dir, "_",  loop_area_id[kk], "_biomass_pct_ts.png")),
      width = 8, 
      height = 6, 
      units = "in", 
      res = 300)
  ...
  png(filename = 
        here::here("analysis", "effort_reduction", "plots", sub_dir, survey_set, 
                   paste0(survey_set, "_fish_", sub_dir, "_", loop_area_id[kk], "_cv_diff.png")),
      width = 8, 
      height = 6, 
      units = "in", 
      res = 300)
  ...
  for(ll in 1:nrow(akfin_species)) {
    ...
    png(filename = 
          here::here("analysis", "effort_reduction", "plots", sub_dir, survey_set, 
                     paste0(survey_set, "_fish_", sub_dir, "_", loop_area_id[kk], "_", akfin_species$SPECIES_CODE[ll], "_diff.png")),
        width = 8, 
        height = 6, 
        units = "in", 
        res = 300)

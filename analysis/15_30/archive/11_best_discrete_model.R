...
for(ii in 1:length(sp_code)) {
  ...
  pratio_df <- discrete_cv(count1 = spp_lengths$N_30,
...
saveRDS(pratio_samples, file = here::here("analysis", "15_30", "output", "discrete_samples.rds"))

write.csv(rmse_df, here::here("analysis", "15_30", "output", "discrete_model_rmse.csv"), row.names = FALSE)
